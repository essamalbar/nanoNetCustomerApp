...
public class TicketModel {
    ...
    public void addAnswer(TicketAnswerModel model) {
        this.answerModels.add(model);
    }

    public void deleteAnswer(TicketAnswerModel model) {
        this.answerModels.remove(model);
    }
